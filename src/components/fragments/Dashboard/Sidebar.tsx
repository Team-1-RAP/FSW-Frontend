...
const SideBar: React.FC<SidebarProps> = ({ isAsideOpen, closeAside }) => {
  ...
  return (
    <>
        ...
        <div className="flex flex-col justify-between h-full">
          <ul className="flex flex-col gap-1 mt-2">
            ...
            <li className="w-[164px]">
              <Link
                to="/pengaturan"
                className={getLinkClass("/pengaturan")}
      ...
      <aside
        id="aside"
        className={`lg:hidden fixed inset-y-0 left-0 z-50 bg-white w-[209px] h-screen flex flex-col items-center pb-4 shadow transition-transform ${
