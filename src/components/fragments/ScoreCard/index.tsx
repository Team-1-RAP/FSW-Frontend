...
const ScoreCard = ({
  ...
  return (
    <div className="flex items-center bg-white p-4 rounded-3xl shadow-md" tabIndex={0} aria-label={ariaLabel}>
        ...
        {isVisible ? null : (
          ...
          >
            ...
            <button
              ...
              className="text-[#718EBF] ms-2"
            >
              <Copy className="w-4" onClick={handleCopy} />
            </button>
          </div>
        )}
        {copied && (
