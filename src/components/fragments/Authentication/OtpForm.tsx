...
export const OtpForm = ({ onSubmit, email, errorMessage }: OtpFormProps) => {
  ...
  return (
    <FormResetPasswordPinTemplate title="Kode OTP" message="Masukan kode OTP yang telah dikirimkan melalui Email ke" email={email}>
          ...
          render={({ field }) => (
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`w-full h-12 border-[1px] rounded-[10px] px-4 ${errors.otp ? "input-error" : "border-[#A09FA4]"}`}
              />
