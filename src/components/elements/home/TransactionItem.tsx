...
const TransactionItem: React.FC<TransactionItemProps> = ({ icon, label, value, color }) => {
  return (
    <div className="md:w-[331px] md:h-[98px] bg-white mx-2 flex flex-col items-start justify-center text-center rounded-2xl p-3">
      <div className="flex items-center justify-center">
        ...
        <div className="flex flex-col items-start justify-start">
          ...
          <span className="text-[22px] font-semibold text-[#232323]">{value}</span>
        </div>
      </div>
    </div>
  )
