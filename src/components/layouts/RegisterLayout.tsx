...
const RegisterLayout = () => {
  ...
  // Function to determine if the current path is one of the excluded paths
            ...
            <div className="px-4 pt-32 md:px-6 md:pt-10">
              <header className="border-b border-[#A09FA4] h-auto pb-2 md:pb-0">
                ...
                <div className="hidden md:flex md:flex-row md:gap-16">
                  <Link to="/register" className="relative flex items-center justify-center md:justify-start">
                  ...
                  <Link to="/register/verifikasi-email" className="relative flex items-center justify-center flex-1 md:justify-start">
                  ...
                  <Link to="/register/tipe-rekening" className="relative flex items-center justify-center flex-1 md:justify-start">
                  ...
                  <Link to="/register/data-diri" className="relative flex items-center justify-center flex-1 md:justify-start">
                  ...
                  <Link to="/register/upload-persyaratan" className="relative flex items-center justify-center flex-1 md:justify-start">
                  ...
                  <Link to="/register/selesai" className="relative flex items-center justify-center flex-1 md:justify-start">
