          ...
          <div className="px-4 md:px-6 pt-32 md:pt-10">
            <header className="border-b border-[#A09FA4] h-auto">
              <div className="flex flex-col md:flex-row gap-4 md:gap-16 px-2 md:px-0">
                <Link to="/register" className="relative flex-1 flex items-center justify-center md:justify-start">
                ...
                <Link to="/register/verifikasi-email" className="relative flex-1 flex items-center justify-center md:justify-start">
                ...
                <Link to="/register/tipe-rekening" className="relative flex-1 flex items-center justify-center md:justify-start">
                ...
                <Link to="/register/data-diri" className="relative flex-1 flex items-center justify-center md:justify-start">
                ...
                <Link to="/register/upload-persyaratan" className="relative flex-1 flex items-center justify-center md:justify-start">
                ...
                <Link to="/register/selesai" className="relative flex-1 flex items-center justify-center md:justify-start">
