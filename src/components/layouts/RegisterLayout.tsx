                    ...
                    <div className="px-4 pt-32 md:px-6 md:pt-10">
                        <header className="border-b border-[#A09FA4] h-auto pb-2 md:pb-0">
                            ...
                            <div className="flex justify-center gap-4 md:hidden">
                                {[
                                    ...
                                    <Link
                                        key={step}
                                        to={path}
                                        className={`flex items-center justify-center w-8 h-8 text-white rounded-full border ${
                                            location.pathname === path
                                                ? "bg-blue-500 border-blue-700"
                                                : "bg-gray-200 border-[#A09FA4]"
                                        }`}
                                    >
                                        {step}
                                    </Link>
                            ...
                            <div className="hidden md:flex md:flex-row md:gap-16">
                                ...
                                >
                                    ...
                                    <div
                                        className={`absolute bottom-0 left-0 w-full ${
                                            getLinkClass("/register").underline
                                        }`}
                                        style={{ height: "2px" }}
                                        aria-hidden
                                    />
                                ...
                                <Link
                                    to="/register/upload-persyaratan"
                                    className="relative flex items-center justify-center flex-1 md:justify-start"
                                >
                                    <div
                                        className={`text-center md:text-left ${
