        ...
        <div className="min-h-screen overflow-hidden bg-white ">
            ...
            <header className="flex flex-col justify-between p-3 px-16 bg-white md:items-center md:flex-row">
                ...
                <div className="flex ml-[-40px] md:ml-0">
                    ...
                    <button className="px-4 py-2 text-white rounded-xl bg-[#0079CB] drop-shadow-md w-[120px] h-[40px] md:w-[140px] md:h-[50px]" onClick={handleLoginClick} aria-label="Tombol Login">
                        Login
                    </button>
                </div>
            </header>
            ...
            <section className="py-10 mt-[55px] flex flex-col">
                ...
                <div className="relative overflow-hidden">
                    ...
                    <Marquee speed={30} gradient={true} gradientColor="white" gradientWidth={gradientWidth}>
