...
const FinishNewAccount: React.FC = () => {
    ...
    return (
        <div className="text-center w-[605px] flex flex-col items-center gap-4">
            ...
            <p className="text-base font-normal">Saat ini, data Anda sedang kami lakukan verifikasi. Harap tunggu email konfirmasi dari SimpleBank untuk tahapan berikutnya.</p>
